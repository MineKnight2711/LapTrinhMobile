                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: CustomInputTextField(
                          ...
                          controller:
                              addressController.houseAndStreetController,
                      ...
                      Container(
                        ...
                        child: CustomInputTextField(
                          ...
                          controller:
                              addressController.districtAndCityController,
                        ...
                        child: Row(
                          children: [
                            ...
                            Transform.scale(
                              ...
                              child: Obx(
                                () => Switch(
                                  value: addressController.defaultAddress.value,
                                  onChanged: (value) {
                      ...
                      Container(
                          ...
                          child: Obx(
                            () => DefaultButton(
                              enabled:
                                  addressController.isValidReceiverName.value &&
                                      addressController
                                          .isValidReceiverPhone.value &&
                                      addressController
                                          .isValidHouseAndStreet.value &&
                                      addressController.isValidWard.value &&
                                      addressController
                                          .isValidDistrictAndCity.value,
                              text: "Thêm địa chỉ",
                              press: () async {
                                final currentAccount = await addressController
                                    .awaitCurrentAccount();
